...
class ModelConfigModel(BaseModel):
    ...
    mlflow_model_name: Optional[str] = Field(default=None, description="MLFlow model name")
    mlflow_model_alias: Optional[str] = Field(default=None, description="MLFlow model alias")
...
class ProcessingConfigModel(BaseModel):
    ...
    num_workers: int = Field(default=0, ge=0, description="Number of workers for inference")
