...
class TileUtils:
    ...
    def validate_results(
        ...
        # Single vectorized comparison for all tiles with more tolerance
        # SAHI might produce slightly different results due to different slicing logic
...
class TileUtilsv2:
    ...
    def get_patches_and_offset_info(
        ...
        try:
            ...
            if validate:
                TileUtilsv2.validate_results(image, patches_tensor, offset_info)
