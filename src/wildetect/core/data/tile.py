    ...
    def _set_timestamp(self):
        if self.parent_image:
            try:
                ...
                logger.warning(f"Failed to set timestamp from parent image {self.parent_image}: {e}")
            ...
            try:
                ...
                logger.warning(f"Failed to set timestamp from image path {self.image_path}: {e}")
