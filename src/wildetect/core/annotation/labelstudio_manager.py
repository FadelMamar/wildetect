...
class LabelStudioManager:
    ...
    def __init__(self, url: Optional[str] = None, api_key: Optional[str] = None):
        ...
        self.url = url or self.config.get("labelstudio", {}).get(
    ...
    def import_tasks_from_fiftyone(
        self,
        project: Project,
        dataset_name: str,
        ...
        try:
            ...
            for i, image_path in enumerate(image_paths):
                task = {
                    "data": {"image": f"/data/upload/{os.path.basename(image_path)}"}
                }
                ...
                if detections and i < len(detections):
                    ...
                    if "detections" in detection:
                        ...
                        task["annotations"] = [
                            {"result": annotations, "completed_by": 1}
                        ]
    ...
    def export_annotations_to_fiftyone(
        self, project: Project, output_dir: str
    ) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if stats["total_tasks"] > 0:
                stats["completion_rate"] = (
                    stats["annotated_tasks"] / stats["total_tasks"]
                )
    ...
    def create_annotation_job(
        ...
        try:
            ...
            # Import tasks
            self.import_tasks_from_fiftyone(
                project, project_name, image_paths, detections
            )
    ...
    def export_for_training(
        self, project: Project, output_dir: str, format: str = "yolo"
    ):
    ...
    def _export_coco_format(self, annotations: List[Dict[str, Any]], output_dir: str):
        ...
        for i, class_name in enumerate(class_names):
            coco_data["categories"].append(
                {"id": i, "name": class_name, "supercategory": "wildlife"}
            )
