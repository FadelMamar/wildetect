...
def main():
    ...
    add_parser.add_argument('--dataset', help='Dataset name (default: wildlife_detection)')
    ...
    export_parser.add_argument('--format', default='coco', choices=['coco', 'yolo', 'pascal'], help='Export format')
    export_parser.add_argument('--dataset', help='Dataset name (default: wildlife_detection)')
    
    # Stats command
    stats_parser = subparsers.add_parser('stats', help='Show dataset statistics')
    stats_parser.add_argument('--dataset', help='Dataset name (default: wildlife_detection)')
