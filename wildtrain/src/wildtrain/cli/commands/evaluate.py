...
def classifier(
    ...
    try:
        ...
        console.print("[bold green]✓[/bold green] Classification evaluation configuration validated successfully")
...
def detector(
    ...
    try:
        ...
        console.print("[bold green]✓[/bold green] Detection evaluation configuration validated successfully")
