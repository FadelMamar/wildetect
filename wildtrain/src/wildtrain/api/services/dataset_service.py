...
class DatasetService:
    ...
    def get_dataset_stats(
        data_dir: Path, split: str = "train", output_file: Optional[Path] = None
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            formatted_results = {
                "stats": {"mean": results["mean"], "std": results["std"]},
                "split_info": {"split": split, "data_dir": str(data_dir)},
            }
    ...
    def get_dataset_splits(data_dir: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                splits["train"] = {
                    "exists": True,
                    "count": len(datamodule.train_dataset)
            ...
            try:
                ...
                splits["val"] = {
                    "exists": True,
                    "count": len(datamodule.val_dataset)
            ...
            try:
                ...
                splits["test"] = {
                    "exists": True,
                    "count": len(datamodule.test_dataset)
