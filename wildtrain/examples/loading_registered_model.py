...
def load_detector():
    model = load_registered_model(alias="demo", name="detector", load_unwrapped=True)
...
def load_from_config():
    localizer_cfg = OmegaConf.load(
        "models-registry/detector/10/artifacts/localizer_config.yaml"
    )
